...
print("[Info] Setting up SENS_shear configuration...")
...
disp = np.concatenate((np.linspace(0.0, 0.21, 8), np.linspace(0.24, 0.5, 27)), axis=0)
disp = disp[1:]

coarse_mesh_file = "mesh/Sens_initial.msh"
fine_mesh_file = "mesh/Sens_initial.msh"
...
def setup_run_artifacts():
    ...
    model_path = PATH_ROOT / "result" / f"shear_refine_{date}"
